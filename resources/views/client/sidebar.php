            ...
            <div class="data-scrollbar" data-scroll="1">
                <nav class="iq-sidebar-menu">
                    ...
                    <ul id="iq-sidebar-toggle" class="side-menu">
                        ...
                        <?php if($CMSNT->site('status_dichvugame') == 1):?>
                        <li class="<?=active_sidebar_client(['shop-dichvu']);?> sidebar-layout">
                            <a href="<?=base_url('client/shop-dichvu');?>" class="svg-icon ">
                                <i class="fas fa fa-rocket"></i>
                                <span class="ml-2"><?=__('Dịch Vụ Game');?></span>
                            </a>
                        </li>
                        <?php endif?>
                        ...
                        <li class="sidebar-layout">
                            <a href="#app1" class="svg-icon collapsed" data-toggle="collapse" aria-expanded="false">
                                ...
                                <span class="ml-2"><?=__('Lịch sử');?></span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="svg-icon iq-arrow-right arrow-active"
                                    width="15" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 5l7 7-7 7"></path>
                            ...
                            <ul id="app1"
                                class="submenu collapse <?=show_sidebar_client(['orders', 'dichvu-history']);?>"
                        ...
                        <li class="<?=active_sidebar_client(['dichvu-history']);?> sidebar-layout">
                            <a href="<?=base_url('client/dichvu-history');?>" class="svg-icon ">
                                <i class="fas fa fa-rocket"></i>
                                <span class="ml-2"><?=__('Lịch Sử Dịch Vụ');?></span>
                            </a>
                        </li>
                            </ul>
                        </li>
                        <?php elseif ($CMSNT->site('status_dichvugame') == 0):?>
                        <li class="<?=active_sidebar_client(['orders']);?> sidebar-layout">
                            <a href="<?=base_url('client/orders');?>" class="svg-icon ">
                                <i class="fas fa-history"></i>
                                <span class="ml-2"><?=__('Lịch Sử Mua Hàng');?></span>
