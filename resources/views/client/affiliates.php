...
require_once(__DIR__.'/sidebar.php');
 ...
 $getdomain = $CMSNT->get_row("SELECT * FROM `domains` WHERE `user_id` = '".$getUser['id']."' ");
?>
               ...
               <div class="card">
                                    <div class="card-body">
                                        <div class="mb-5">
                                            ...
                                            <input type="text" class="form-control" id="domain" placeholder="Không được tạo miền quá 8 kí tự ,dấu . nên đặt ngắn gọn theo tên" aria-label="Không được tạo miền quá 8 kí tự ,dấu . nên đặt ngắn gọn theo tên" aria-describedby="basic-addon2">
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2">.<?=$_ENV['DOMAIN_CHINH']?></span>
                                            </div>
                                        </div>
                                        <center>
                                            <button class="btn btn-danger btn-sm" id="btnSubmit" type="button"><i class="fa-solid fa-plus mr-1"></i>TẠO NGAY</button>
                                        </center>
...
$("#btnSubmit").on("click", function() {
    $('#btnSubmit').html('<i class="fa fa-spinner fa-spin"></i>').prop('disabled',
        true);
    $.ajax({
        url: "<?=BASE_URL('ajaxs/client/CtvDoamin.php');?>",
        method: "POST",
        dataType: "JSON",
        data: {
