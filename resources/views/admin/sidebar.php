    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="<?=base_url('admin/');?>" class="brand-link">
               <center> <img width="100%" src="https://i.imgur.com/nMxPgiz.png" alt="DichVuRight"></center>
            </a>
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item <?=menuopen_sidebar(['dichvugame', 'dichvugame-add', 'dichvugame-edit', 'dichvu-cho', 'dichvu-xuly', 'dichvu-huy', 'dichvu-hoantat', 'dichvu-setting', 'dichvugame-groups', 'dichvu-editgroups']);?>">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa fa-rocket"></i>
                                <p>
                                    Dịch vụ game
                                    <i class="fas fa-angle-left right"></i>
                                </p>
                                <span class="badge badge-info"><?=$CMSNT->num_rows("SELECT * FROM `dichvu_history` WHERE `status` = 'choduyet' ");?></span>
                            </a>
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?=BASE_URL('admin/dichvugame');?>"
                                        class="nav-link <?=active_sidebar(['dichvugame', 'dichvugame-edit', 'dichvugame-add', 'dichvugame-groups', 'dichvu-editgroups']);?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Chuyên mục</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?=BASE_URL('admin/dichvu-cho');?>"
                                        class="nav-link <?=active_sidebar(['dichvu-cho']);?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Đơn chờ duyệt</p>
                                        <span class="badge badge-info"><?=$CMSNT->num_rows("SELECT * FROM `dichvu_history` WHERE `status` = 'choduyet' ");?></span>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="<?=BASE_URL('admin/dichvu-xuly');?>"
                                        class="nav-link <?=active_sidebar(['dichvu-xuly']);?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Đơn xử lý</p>
                                        <span class="badge badge-warning"><?=$CMSNT->num_rows("SELECT * FROM `dichvu_history` WHERE `status` = 'xuly' ");?></span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?=BASE_URL('admin/dichvu-hoantat');?>"
                                        class="nav-link <?=active_sidebar(['dichvu-hoantat']);?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Đơn hoàn tất</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?=BASE_URL('admin/dichvu-huy');?>"
                                        class="nav-link <?=active_sidebar(['dichvu-huy']);?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Đơn huỷ</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?=BASE_URL('admin/dichvu-setting');?>"
                                        class="nav-link <?=active_sidebar(['dichvu-setting']);?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Cấu hình</p>
                                    </a>
                                </li>
