...
$V2F2F2 = 'DichVuRight';
if ($V2F2F2 != $_ENV['SECRET_KEY']) { 
    exit(base64_decode(base64_decode(base64_decode('VTBkV2MySjVRa1ZoVjA1dlZtNVdVMkZYWkc5a1EwSkVZVTFQWjJKNVFtazBZbkZvWW1sQk5rdFRhM0JMVVQwOQ=='))));
}
