<?php
    ...
    if ($CMSNT->site('type_bank') == 'Vietcombank') {
        $result = curl_get("https://chungapi.net/api/historyvietcombank/$token");
    ...
    if ($CMSNT->site('type_bank') == 'ACB') {
        $result = curl_get("https://chungapi.net/api/historyacb/$token");
        $result = json_decode($result, true);
    ...
    if ($CMSNT->site('type_bank') == 'MBBank') {
        $result = curl_get("https://chungapi.net/api/historymbbank/$token");
        $result = json_decode($result, true);
    ...
    if ($CMSNT->site('type_bank') == 'TPBank') {
        $result = curl_get("https://chungapi.net/api/historytpb/$token");
        $result = json_decode($result, true);
